...
export default $config({
  ...
  async run() {
    ...
    const auroraEnv = {
      AURORA_BACKOFFICE_URL: isProduction ? 'https://api-backoffice.aur.lu':'https://api.backoffice.dev.aur.lu/api',
      AURORA_PORTAL_URL: isProduction ? 'https://api-portal.aur.lu/' : 'https://api.portal.dev.aur.lu/api',
    ...
    const auroraS3GatewayUrl = isProduction ? 'https://a-fil-one-s3.aur.lu' : 'https://s3.dev.aur.lu';
